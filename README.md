...
| Покрытие существенных условий (Стадия 3): статус каждой темы (соответствует / противоречит / отсутствует / неоднозначно + инженерские «в другом документе» / «проверка договора» / «неприменимо»), 24 договорные темы покрытия (включая ПНР, страхование, расторжение, давальческие, BIM, права на документацию), «условие отсутствует» — безъякорная находка с действием (запрос / допущение / условие КП / проверка договора / резерв), матрица `conditions/coverage` + панель на странице условий | ✅ Реализовано |
