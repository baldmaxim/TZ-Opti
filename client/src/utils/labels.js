...
export const PROBLEM_TYPES = {
  ...
  учтено_частично: 'Учтено частично (не все операции)',
  ...
  условие_отсутствует: 'Условие компании: отсутствует в ТЗ',
  условие_неоднозначно: 'Условие компании: сформулировано неоднозначно',
  // Стадия 4 — типовые риски
  типовой_риск: 'Типовой риск',
  // Стадия 5 — самоанализ ТЗ (challenger)
  пропущенный_риск: 'Пропущено основными стадиями',
